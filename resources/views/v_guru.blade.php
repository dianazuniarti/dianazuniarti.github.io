...
@section('content')
    <a href="/guru/add" class="btn btn-primary btn-sm">Add Guru</a>
    @if (session('pesan'))
        ...
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Apakah anda yakin ingin menghapus data {{ $data->nama_guru }} ?</p>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Cancel</button>
              <a href="/guru/delete/{{ $data->id_guru }}" class="btn btn-outline">Delete</a>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
